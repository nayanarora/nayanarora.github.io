...
def build_pdf() -> Path:
    ...
    draw_paragraph(
        c,
        "The day flow above is only suggestive and is totally flexible as per guest preference. The return buffer is kept so guests arrive by about 4:00 pm — in time to enjoy high tea at the JW Marriott with the rest of the wedding group — before the meet-and-greet welcome dinner begins at 6:30 pm. Actual travel times may vary with road and traffic conditions.",
        left,
        y,
        content_w,
        font="SourceSans",
